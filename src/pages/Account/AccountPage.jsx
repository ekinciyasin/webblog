                ...
                {authState && <div className="account-card">
                    <div>
                        <div className="account-items">
                            <div className="label-column"><p className="accout-items-label">Name:</p></div>
                            <div className="text-column"><p>{username}</p></div>
                            <div className="btn-column"></div>
                        </div>
                        <div className="account-items">
                            <div className="label-column"><p className="accout-items-label">Email:</p></div>
                            <div className="text-column"><p>{email}</p></div>
                        ...
                        <div className="account-items">
                            <div className="label-column"><p className="accout-items-label">Passwort:</p></div>
                            <div className="text-column"><p>{password}</p></div>
                            <div className="btn-column">
                                <button className="btn btn-danger"
                    ...
                    <div className="account-delete-btn">
                        <button className="btn btn-danger" onClick={()=>handleOpenModal(ModalType.DELETE)}>Account löschen</button>
                    </div>
